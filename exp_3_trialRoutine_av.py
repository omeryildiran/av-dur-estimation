...
while not endExpNow and stopped_stair_count!=(len(all_staircases)):
    ...
    #region [rgba(90, 10, 10, 0.200)] # reddish for preparation
    ...
    #testDurS=frames2sec(testDurFrames+conflictDur, frameRate)
    ...
    audio_stim= audio_cue_gen.whole_stimulus(
            ...
            intensity=maxIntensityBurst, rise_dur=0.05, 
    ...
    visualStim=visual.Circle(win, radius=visualStimSize, fillColor=True, lineColor='white', colorSpace='rgb', units='pix',
                        pos=(0, 0))
