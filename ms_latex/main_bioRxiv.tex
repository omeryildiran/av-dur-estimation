...
%%% Compile from this directory with: latexmk -pdf main_bioRxiv.tex
%%% Add the `linenumbers` class option for a line-numbered review copy.
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\biorxivcategory{Neuroscience}
\biorxivlicense{CC BY 4.0}
...
The probabilistic cue-switching model provided the best fits for the largest number of participants (6 out of 11; Figure~\ref{fig:modelComparison}B). However, the individual $\Delta$AIC values were very low, suggesting limited discriminability between decoding strategies under this assumption.
